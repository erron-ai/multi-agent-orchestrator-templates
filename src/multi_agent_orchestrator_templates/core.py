"""Core logic for multi_agent_orchestrator_templates."""
...
def analyze_records(records: list[dict[str, Any]]) -> AnalysisResult:
    ...
    return AnalysisResult(
        ...
        score=score,
        summary=f"{summary} result for: Pre-built orchestration patterns (parallel, sequential, supervisor-worker) for CrewAI, LangGraph, and n8n.",
        signals=signals,
    )
