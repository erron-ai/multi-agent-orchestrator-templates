...
## Objective
Maintain `multi-agent-orchestrator-templates` as a reliable, useful, and test-first project aligned with its primary promise:
> Pre-built orchestration patterns (parallel, sequential, supervisor-worker) for CrewAI, LangGraph, and n8n.
